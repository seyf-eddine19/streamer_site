...
def data_portal(request):
    ...
    form = UploadFileForm()
    return render(request, 'team_dashboard/data_portal.html', {
        'form': form,
        'message': message,
        'status': status,
        'key': key
...
def custom_403(request, exception):
    return render(request, 'team_dashboard/403.html', {}, status=403)

def custom_404(request, exception):
    return render(request, 'team_dashboard/404.html', {}, status=404)

def custom_500(request):
    return render(request, 'team_dashboard/500.html', status=500)

class IndexView(LoginRequiredMixin, TemplateView):
    """عرض الصفحة الرئيسية"""
    template_name = 'team_dashboard/index.html'
...
class ProfileView(LoginRequiredMixin, FormView):
    ...
    template_name = 'team_dashboard/users/profile.html'
...
class UserListView(PermissionRequiredMixin, ListView):
    model = User
    template_name = 'team_dashboard/users/user_list.html'
    context_object_name = 'users'
    permission_required = 'auth.view_user'

class UserDetailView(PermissionRequiredMixin, DetailView):
    model = User
    template_name = 'team_dashboard/users/user_detail.html'
    permission_required = 'auth.view_user'

class UserDeleteView(PermissionRequiredMixin, DeleteView):
    model = User
    template_name = 'team_dashboard/users/user_delete.html'
...
class UserFormView(PermissionRequiredMixin, FormViewMixin):
    model = User
    form_class = UserForm
    template_name = 'team_dashboard/users/user_form.html'
    success_url = reverse_lazy('user_list')
...
class ProjectListView(ListView):
    model = Project
    template_name = 'team_dashboard/projects/list.html'
    context_object_name = 'projects'
    # permission_required = 'projects.view_project'

class ProjectDetailView(DetailView):
    model = Project
    template_name = 'team_dashboard/projects/detail.html'
    # permission_required = 'projects.view_project'

class ProjectDeleteView(PermissionRequiredMixin, DeleteView):
    model = Project
    template_name = 'team_dashboard/projects/delete.html'
...
class ProjectFormView(PermissionRequiredMixin, FormViewMixin):
    ...
    template_name = 'team_dashboard/projects/form.html'
...
def send_whatsapp(request, phone_number, message):
    ...
    return render(request, 'team_dashboard/tasks/send_whatsapp.html', context)


class TaskListView(ListView):
    model = Task
    template_name = 'team_dashboard/tasks/list.html'
